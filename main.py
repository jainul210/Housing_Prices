...
# lin_rmse = -cross_val_score(lin_reg, housin_prepared, housing_lables, scoring="neg_root_mean_squared_error", cv=10)
...
# dec_rmse = -cross_val_score(dec_reg, housin_prepared, housing_lables, scoring="neg_root_mean_squared_error", cv=10)
...
rand_rmse = -cross_val_score(rand_reg, housin_prepared, housing_lables, scoring="neg_root_mean_squared_error", cv=10)
